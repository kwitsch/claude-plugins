...
| `dispatch-agent`      | Sync the current branch (fetch + fast-forward merge), then hand off an independent task to a new, worktree-isolated background Claude Code session (`claude --worktree ... --bg`, managed via `claude agents`) started from the repo's default branch on origin, passing through the given prompt.                                                                                                                                                                                                                                                                        |
