...
| `dispatch-agent`      | Sync the current branch (fetch + fast-forward pull), then hand off further work to a new, worktree-isolated background Claude Code session (`claude --bg`, managed via `claude agents`) cut from its tip, passing through the given prompt.                                                                                                                                                                                                                                                                                                                               |
