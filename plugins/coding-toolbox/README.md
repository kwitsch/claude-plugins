...
| `finish-pr`           | Finalize an existing PR/MR for the current branch before merge — abort if none exists, undraft it, enable GitLab's delete-source-branch-on-merge if off, and reconcile its title/description against the actual diff.                                                                                                                                                                                                                                                                                                                                                     |
