...
> (Claude Code "Create custom subagents"; Agent SDK "Subagents in the SDK"), verified 2026-08-18.
...
- An in-process agent-team teammate that spawns a subagent always runs it in the foreground and refuses `background: true` definitions with an error.
