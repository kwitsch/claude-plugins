...
| `plugin update`             | `claude plugin update <plugin> [-y] [-s scope]`                                                                           | Scope may be `user`/`project`/`local`/`managed`. `-y`/`--yes` accepts a `command`-source plugin's command without confirmation; required when stdin/stdout is not a TTY.                                                                                                                                                                                                              |
