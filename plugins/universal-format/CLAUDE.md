...
See `plugins/universal-format/skills/universal-format/CLAUDE.md` for the `/universal-format:universal-format` command's design.

## Tests

See `test/universal-format/CLAUDE.md` for the suite layout and run commands.
