...
// Deliberately does NOT delegate to context-mode: SessionStart is the one event
// handled wholly by cave-context's own ruleset (context-mode's routing guidance is
// reimplemented inline in sessionprompt.mjs); delegating would double-inject.
