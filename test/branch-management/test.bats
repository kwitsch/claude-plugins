...
@test "userConfig: declares expected toggles plus ci_watch_timeout and review_max_rounds" {
  ...
  assert_success
  assert_output "ci_monitor ci_watch_timeout coderabbit_ci_comments context_index delete_branch_on_merge graphify_branch_update graphify_force_create graphify_pr_commit graphify_pr_update graphify_user_files review_claude review_coderabbit review_codex review_copilot review_max_rounds"
}
