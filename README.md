...
| [universal-format](plugins/universal-format/README.md)           | Formats prettier languages (JS/TS/JSON/YAML/Markdown/CSS/SCSS) in-process before the write and Shell/Java/Kotlin/Python/Go/PHP after it, honoring `.editorconfig` and tool-native configs.                                                                                                    |
