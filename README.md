...
| [coding-toolbox](plugins/coding-toolbox/README.md) | Injects a compressed "golden behavior rules" doc (Interaction/Language/Behavior/Mentality) at session start, re-injects a short reminder before consequential tool calls, and provides fresh-branch, fresh-pr and fresh-work skills for self-contained git branch, PR/MR and end-to-end work pipeline management. |
