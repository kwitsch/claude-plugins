...
| [kiwi-code-style](plugins/kiwi-code-style/README.md)             | Ships the kiwi-code-style output style: a machine-optimized, emoji-legend response format enforced whenever this plugin is enabled.                                                                                                                                                           |
