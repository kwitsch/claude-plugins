...
| [coding-toolbox](plugins/coding-toolbox/README.md) | Injects a compressed "golden behavior rules" doc (Language/Behavior/Mentality) at session start and re-injects a short reminder before consequential tool calls. |
