...
| [coding-toolbox](plugins/coding-toolbox/README.md) | Injects a compressed "golden behavior rules" doc (Interaction/Language/Behavior/Mentality) at session start, re-injects a short reminder before consequential tool calls, blocks content operations on non-UTF-8 files with an encoding hint, and provides fresh-branch, fresh-pr, fresh-work and bump-version skills for self-contained git branch, PR/MR, end-to-end work pipeline and semver version-bump management. |
