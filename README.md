...
| [superpowers-automation](plugins/superpowers-automation/README.md) | Advisor-review automation for the superpowers workflow: spec/plan hooks plus an on-demand save-advisor file-revise skill. |
